...
//   // Fallback defensivo para evitar erro se rules vier undefined
...
//   const activeRules = safeRules.filter(rule => rule.isActive)
//   const inactiveRules = safeRules.filter(rule => !rule.isActive)
